...
def frame(step):
    ...
    if step > 30:
        ...
        if step == 34:
            ...
            alphact_stage_one_sliced_mol.move_to([0,0,0])
        if step == 35:
            INSULIN_RECEPTOR_SECOND_PDBFILE = pdb.PDBMolecule("/homes/kdijkstra/thema2/pdb/4oga.pdb", center=False, offset=[-10, 8, -5])
            ins_id_two, atom_pos_two = get_ins("/homes/kdijkstra/thema2/pdb/4oga.pdb")
